...
* =====================
* ver 1.5 : 17 Mar 2017
* - Type Analysis and Dependency Analysis called from main()
* ver 1.4 : 26 Feb 2017
* - Professor's code
*/
...
using namespace DependencyTableNamespace;
...
//----< display header line for displayMetrics() >------------------
...
int main(int argc, char* argv[])
{
  ...
  try {
	...
	std::cout << "\n -------------------------------------------------------------------------------------------------- ";
	std::cout << "\n Requirement 2 ";
	std::cout << "\n used the C++ standard library's streams for all I/O and";
	std::cout << " new and delete for all heap-based memory management ";
	std::cout << "\n -------------------------------------------------------------------------------------------------- ";

	std::cout << "\n -------------------------------------------------------------------------------------------------- ";
	std::cout << "\n Requirement 3 ";
	std::cout << "\n enforced the 'Single Responsiblity Principle' for all the packages ";
	std::cout << "\n -------------------------------------------------------------------------------------------------- ";
    ...
    TypeAnal ta;
	DbMain typeTableObj = ta.doTypeAnal();
	...
	DependencyTable depTableObj;
	TypeTable<StringData> depTable;
	Files files = exec.cppHeaderFiles();
	depTable = depTableObj.performDependencyAnalysis(typeTableObj, depTable, files);
